...
Changed from [case04](../case04_ta_dic/): **port spacing 2.00 → 0.60 m**,
...
> Refined by [case10](../case10_bottom_hit/) and
> [case11](../case11_single_port_slow/): truncation happens **only when the
