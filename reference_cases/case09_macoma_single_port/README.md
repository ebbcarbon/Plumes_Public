...
> [case11](../case11_macoma_single_port_slow/README.md).** This file originally
...
> is [case10](../case10_macoma_bottom_hit/).

Pulled 2026-08-12 11:57 (`test9_TxtOutputs.dat`). Settings: **`Ports = 1`**, no
shoreline vector, otherwise [case05](../case05_macoma_merging/)'s configuration
...
[case06](../case06_macoma_arag_s36/)), but here nothing else catches it either: the
