...
**Question.** Which GUI control does `.prj` nearfield_flags position 5 (1-indexed; python [4]) carry? Undecoded in PLAN section 6; constant in every archived project, flipped here and nowhere else.

## Run it

1. Open `flagdecode_nf5.prj` in the exe. **Do not open a hand-maintained
...
|---|---|
| near-field flag 5 (1 -> 0) | unknown -- no candidate |
