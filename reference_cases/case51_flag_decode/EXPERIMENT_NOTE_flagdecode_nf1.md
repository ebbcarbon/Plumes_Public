...
**Question.** Which GUI control does `.prj` nearfield_flags position 1 (1-indexed; python [0]) carry? Undecoded in PLAN section 6; constant in every archived project, flipped here and nowhere else.

## Run it

1. Open `flagdecode_nf1.prj` in the exe. **Do not open a hand-maintained
...
|---|---|
| near-field flag 1 (1 -> 0) | a stop box is the natural candidate (bottom hit is ticked by default and position 2 is already the surface box, case46) |
