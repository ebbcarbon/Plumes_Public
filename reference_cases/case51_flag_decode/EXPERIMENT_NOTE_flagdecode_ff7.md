...
**Question.** Which GUI control does `.prj` farfield_flags position 7 (1-indexed; python [6]) carry? Undecoded in PLAN section 6; constant in every archived project, flipped here and nowhere else.

## Run it

1. Open `flagdecode_ff7.prj` in the exe. **Do not open a hand-maintained
...
|---|---|
| far-field flag 7 (0 -> 1) | unknown -- constant 0 in every archived project |
...
generated  2026-09-01T22:53:22Z
