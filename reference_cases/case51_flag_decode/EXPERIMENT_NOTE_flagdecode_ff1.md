...
**Question.** Which GUI control does `.prj` farfield_flags position 1 (1-indexed; python [0]) carry? Undecoded in PLAN section 6; constant in every archived project, flipped here and nowhere else.

## Run it

1. Open `flagdecode_ff1.prj` in the exe. **Do not open a hand-maintained
...
|---|---|
| far-field flag 1 (1 -> 0) | unknown -- constant 1 in every archived project |
